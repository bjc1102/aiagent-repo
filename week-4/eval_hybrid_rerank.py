...
from rag_pipeline import (
    ...
    load_vectorstore,
    search_documents_hybrid_rerank,
    generate_answer,
...
RESULT_PATH = OUTPUT_DIR / "hybrid_rerank_eval_results.json"
JSONL_RESULT_PATH = OUTPUT_DIR / "hybrid_rerank_eval_results.jsonl"
...
def main():
    ...
    for idx, row in enumerate(dataset_rows, start=1):
        ...
        retrieved_docs = search_documents_hybrid_rerank(
